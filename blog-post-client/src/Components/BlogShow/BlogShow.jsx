      ...
      <section className="bg-white ">
        <div className="container px-6 py-10 mx-auto">
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
            ...
            <div className="flex flex-col items-center p-6 justify-between space-y-3 text-center bg-gray-100 rounded-xl ">
              <span className="inline-block p-3 text-blue-500 bg-blue-100 rounded-full ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-6 h-6"
            ...
            <div className="flex flex-col items-center p-6 space-y-3 justify-between text-center bg-gray-100 rounded-xl ">
              <span className="inline-block p-3 text-blue-500 bg-blue-100 rounded-full ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-6 h-6"
